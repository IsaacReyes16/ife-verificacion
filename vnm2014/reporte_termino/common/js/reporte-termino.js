...
function validar(folio){	
	...
	if($('input:radio[name=reemplazo_'+folio+']:checked').val()==0 && $("#justificacion_"+folio).val()==''){
	...
	if($('input:radio[name=reemplazo_'+folio+']:checked').val()==0 && $('#doc_'+folio).val()==''){
	      	...
	      	$.each(data, function(i, valor){	
	      		var enlace = 'class="link" onclick="desplegar(\''+valor.seccion+'-'+valor.manzana+'\')"';
	       		var rowTitles = 
						...
						+' 	<td '+claseLinea+'>Univ-Req</span></td>'
						+' 	<td '+claseLinea+'>Univ-Reemp</td>'
						+' 	<td '+claseLinea+'>Capturadas</td>'
						+' 	<td '+claseLinea+'>Cap-Req</td>'
						+' 	<td '+claseLinea+'>Cap-Reemp</td>'
						+' 	<td '+claseLinea+'>Pendientes</td>'
						+' 	<td '+claseLinea+'>Pen-Req</td>'
						+'</tr>'
						...
						+' 	<td '+claseLinea2+'>'+valor.TotRequeridos+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotReemplazosOpt+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotCapturadas+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotCapRequeridos+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotCapReemplazadas+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotPendientes+'</td>'
						+' 	<td '+claseLinea2+'>'+valor.TotPenRequeridos+'</td>'
						+'</tr>'
						+'</table></div></td></tr>'
						+'<tr><td >'
