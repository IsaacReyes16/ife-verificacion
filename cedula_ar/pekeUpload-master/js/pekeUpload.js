...
(function($) {
  ...
  $.fn.pekeUpload = function(options){
    ...
    var defaults = {
      ...
      allowedExtensions:  "",
      invalidExtError:    "Tipo de archivo no valido",
      maxSize:      0,
    ...
    this.each(function() {
      ...
      obj.change(function(){
        ...
        if (validateresult()==true){
		  ...
		  obj.next('a').next('div').prepend('<span class="filename">'+file.name+'</span>');
            UploadFile();
          }
          else{
    ...
    function UploadFile(){
      ...
      if (options.theme=="custom"){
        var htmlprogress = '<div class="file"><div class="filename"></div><div id="subida" class="progress-pekeupload"><div id="porcentaje" class="bar-pekeupload pekeup-progress-bar" style="width: 0%;"><span></span></div></div></div>';
      }
              ...
              obj.next('a').next('div').find('.pekeup-progress-bar:first').width(percent+'%');
                ...
                if (data==1){
                  ...
                  if((options.theme == "custom")&&(options.showErrorAlerts==true)){
                    ...
                    //obj.next('a').next('div').prepend('<div class="alert-pekeupload"><button type="button" class="close" data-dismiss="alert">&times;</button> Tipo de archivo no valido.</div>');
